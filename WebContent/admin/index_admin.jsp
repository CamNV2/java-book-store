...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="navbar-header">
            <a class="navbar-brand" href="/BookStore/Admin">Startmin</a>
        </div>
    ...
    <center>
     ...
     <a href="/BookStore/Admin" id="bt" class="bt1">List Server</a>  
     <a href="/BookStore/RealoadAd" id="bt" class="bt1">Home</a>
...
<div align="center">
       ...
       <c:forEach items="${listbook}" var="book">
         <tr>
          ...
          <td>
            <a id="button" class="button1" href="/BookStore/edit?id=<c:out value="${book.id}" ></c:out>">Edit</a>
            &nbsp;&nbsp;&nbsp;&nbsp;
            <a id="button" class="button1" href="/BookStore/delete?id=<c:out value='${bookk.id}' ></c:out>">delete</a>
          </td>
