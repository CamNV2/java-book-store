...
.modal-contents {
    background-image: url("https://anhdephd.com/wp-content/uploads/2017/04/hinh-nen-powerpoint-trang-giay-trang.jpg");
	height: 300px;
	width: 500px;
...
<body>
    ...
    <section>
        ...
        <div class="section2">
                     <!-- Login -->
             <a href="SignUp.jsp" id="btt" class="btt2">Sign Up</a>
             <div class="login">
                <a href="#" id="button" class="button1">Login</a>
               
                  <div class="bg-modal">
                     <div class="modal-contents">

                         <div class="close">+</div>
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT7SAMeKqgrVcHTQXhZ2wjElpXepD3p0iz_5EpczM74t_M56lR-yA" class="loginn">
                            <form action="/BookStore/LOGIN" method="get">
                            <input type="text" placeholder="Name" name="username">
                            <input type="password" placeholder="Password" name="password">
                         	<input type="submit" value="Login" id="LG" class="LG1" width="30px" >
            ...
            <nav>
                <a class="menuitem" href="/BookStore/Reload" >Home</a>
            ...
            <div class="product">
             <c:forEach items="${listbook}" var="book">
                <fieldset class="col1">
                    ...
                    <legend>New</legend>
                    <img style="width: 30px" src="data:image/jpg;base64,${book.base64Image}" class="img11" /> 
